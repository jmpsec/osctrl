  ...
  ({ className, error, ...props }, ref) => {
    return (
      <input
        ref={ref}
        className={cn(
          'w-full h-8 bg-[color:var(--bg-1)] border rounded-md',
          'px-2.5 text-sm text-[color:var(--text-1)]',
          ...
          error
            ...
            : 'border-[color:var(--border-strong)] focus:border-[color:var(--accent)] focus:shadow-[0_0_0_2px_var(--accent-soft)]',
