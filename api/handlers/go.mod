...
require (
	github.com/jmpsec/osctrl/cache v0.0.0-20250203202337-3998cdcbfbca
	github.com/jmpsec/osctrl/carves v0.0.0-20250203202337-3998cdcbfbca
	github.com/jmpsec/osctrl/environments v0.0.0-20250203202337-3998cdcbfbca
	github.com/jmpsec/osctrl/logging v0.0.0-20250203202337-3998cdcbfbca
	github.com/jmpsec/osctrl/metrics v0.0.0-20250203202337-3998cdcbfbca
	github.com/jmpsec/osctrl/nodes v0.4.2
	github.com/jmpsec/osctrl/queries v0.4.2
	github.com/jmpsec/osctrl/tags v0.0.0-20250203202337-3998cdcbfbca
	github.com/jmpsec/osctrl/users v0.0.0-20250203202337-3998cdcbfbca
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.17.57 // indirect
