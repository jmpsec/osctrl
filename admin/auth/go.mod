...
require (
	github.com/jmpsec/osctrl/admin/sessions v0.0.0-00010101000000-000000000000
	github.com/jmpsec/osctrl/settings v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/jmpsec/osctrl/queries v0.2.6 // indirect
