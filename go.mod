...
require (
	...
	github.com/jmpsec/osctrl/admin/handlers v0.3.3
	github.com/jmpsec/osctrl/admin/sessions v0.3.3
	github.com/jmpsec/osctrl/backend v0.3.3
	github.com/jmpsec/osctrl/cache v0.3.3
	github.com/jmpsec/osctrl/carves v0.3.3
	github.com/jmpsec/osctrl/environments v0.3.3
	github.com/jmpsec/osctrl/logging v0.3.3
	github.com/jmpsec/osctrl/metrics v0.3.3
	github.com/jmpsec/osctrl/nodes v0.3.3
	github.com/jmpsec/osctrl/queries v0.3.3
	github.com/jmpsec/osctrl/settings v0.3.3
	github.com/jmpsec/osctrl/tags v0.3.3
	github.com/jmpsec/osctrl/tls/handlers v0.3.3
	github.com/jmpsec/osctrl/types v0.3.3
	github.com/jmpsec/osctrl/users v0.3.3
	github.com/jmpsec/osctrl/utils v0.3.3
	github.com/jmpsec/osctrl/version v0.3.3
